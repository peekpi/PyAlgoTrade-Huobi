...
from web import HuobiWebSocket
...
#    f=lambda x:x[0:4]+"-"+x[4:6]+"-"+x[6:8]+" "+x[8:10]+":"+x[10:12]+":"+x[12:14]
    return bar.BasicBar(barDict["time"], barDict["open"], barDict["high"], barDict["low"], barDict["close"], barDict["vol"], None, frequency)


class GetBarThread(PollingThread, HuobiWebSocket):
    ...
    def __init__(self, queue, identifiers, frequency, apiCallDelay):
        ...
        HuobiWebSocket.__init__(self, "wss://api.huobi.com/ws")
